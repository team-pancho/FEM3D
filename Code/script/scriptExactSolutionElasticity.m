% coefficients and functions for a smooth exact solution of 
% a steady state elasticity problem 
% wih nonhomogeneous isotropic materials
% 
...
s=1;
rho = @(x,y,z) (x.^2 + 1).*((y-1).^2+2).*((z-2).^2+3);
